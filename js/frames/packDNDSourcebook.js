...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'dndSourcebook';
	//art bounds
	card.artBounds = {x:0.04, y:0.11, width:0.92, height:0.452};
	autoFitArt();
	//set symbol bounds
	card.setSymbolBounds = {x:0.9213, y:0.5953, width:0.12, height:0.0410, vertical:'center', horizontal: 'right'};
	resetSetSymbol();
	//watermark bounds
