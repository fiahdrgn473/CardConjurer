...
var uniqueFunctionName = "planeswalkerTallCustomFunction"

function planeswalkerTallCustomFunction() {
	//Bottom info is important
	bottomInfoM15()
	//But now it has to draw/write the loyalty things!
	var abilityLineY = 580
...
setTimeout(function(){if (document.getElementById("borderSelection").value == "planeswalkerTall/") {planeswalkerAbilityLines()}}, 1000)